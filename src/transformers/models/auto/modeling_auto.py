...
from ..exbert.modeling_exbert import (
    exBertForMaskedLM,
    exBertForCausalLM,
...
(exBertConfig, exBertForMaskedLM),
...
MODEL_FOR_CAUSAL_LM_MAPPING = OrderedDict(
    [
        ...
        (exBertConfig, exBertForCausalLM),
...
MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING = OrderedDict(
    [
        ...
        (exBertConfig, exBertForSequenceClassification),
...
MODEL_FOR_QUESTION_ANSWERING_MAPPING = OrderedDict(
    [
        ...
        (exBertConfig, exBertForQuestionAnswering),
...
(exBertConfig, exBertForTokenClassification),
...
(exBertConfig, exBertForMultipleChoice),
